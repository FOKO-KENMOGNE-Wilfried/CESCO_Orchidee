...
function Header(){
    ...
    return(
        <div className=" flex justify-center">
            <div className=" flex justify-between border-2 bg-white mt-16 w-11/12 items-center p-4 rounded-lg screen1:text-sm screen2:flex-col screen2:gap-10 absolute">
